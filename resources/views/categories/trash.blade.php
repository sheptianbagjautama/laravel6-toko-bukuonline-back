                                  ...
                                  <table id="pengguna" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('categories.restore', [$category->id]) }}" class="btn btn-default"><i class="fa fa-window-restore"></i> Restore</a>
                                        </td>
                                        <td>
                                            {{-- <form 
                                            ...
                                            <form 
                                                ...
                                                onsubmit="return confirm('Hapus data ke secara permanen ?')"
                                                method="POST">
